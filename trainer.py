...
from data_loader_new import (create_vectorizations, load_data, make_dataset,
                         save_vectorization, load_vectorization_from_disk)
from transformer_model import TransformerModel


file_path = './archive (3)/old-newspaper-vietnamese.txt'
...
def train_from_scratch():
    ...
    transformer = TransformerModel(source_vectorization=source_vectorization,
        ...
        dense_dim=8192, num_heads=8, drop_out=0.2)
...
def continue_training():
    source_vectorization = load_vectorization_from_disk('./result/source_vectorization_layer.pkl')
    target_vectorization = load_vectorization_from_disk('./result/target_vectorization_layer.pkl')
